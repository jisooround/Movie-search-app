...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/getDetail.js":[function(require,module,exports) {
"use strict";
...
function _getDetail() {
  _getDetail = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var id,
      _args = arguments;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              fetch("https://omdbapi.com/?apikey=7035c60c&i=".concat(id, "&plot=sho")).then(function (res) {
                return res.json();
              }).then(function (res) {
                return resolve(res);
              }).then(function (json) {
...
;
},{}],"js/renderDetail.js":[function(require,module,exports) {
"use strict";
...
var _getDetail = _interopRequireDefault(require("./getDetail.js"));
var _renderDetail = _interopRequireDefault(require("./renderDetail.js"));
...
function _detail() {
  _detail = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(movie) {
    var id, details;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _getDetail.default)(id);
          case 4:
...
;
},{"./getDetail.js":"js/getDetail.js","./renderDetail.js":"js/renderDetail.js"}],"js/renderMovies.js":[function(require,module,exports) {
"use strict";
...
},{"./detail.js":"js/detail.js"}],"js/getMovies.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              fetch("https://omdbapi.com/?apikey=7035c60c&s=".concat(title, "&page=").concat(page, "&type=").concat(type, "&y=").concat(year)).then(function (res) {
                return res.json();
              }).then(function (res) {
                return resolve(res);
              }).then(function (json) {
...
function scroll() {
  var scrollEl = document.getElementsByClassName('scroll');
  var sections = document.getElementsByClassName('section');
  var introTop = sections[0].offsetTop;
...
var _renderMovies = _interopRequireDefault(require("./renderMovies.js"));
var _getMovies = _interopRequireDefault(require("./getMovies.js"));
...
var moreBtnEl = document.getElementById('more-btn');
var movieFeed = document.getElementById('movieFeed');
...
function _searchMoviesFirst() {
  _searchMoviesFirst = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var year, typeEl, type, countEl, title, i, _yield$getMovies2, movies, totalResults, total;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            typeEl = document.getElementById('type-select');
...
moreBtnEl.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var title, _yield$getMovies, movies, totalResults;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
...
function renderMoreBtn(totalResults) {
  var total = Math.ceil(Number(totalResults) / 10);
  if (page < total) {
...
function yearList() {
  ...
  for (var i = currentYear; i >= 1980; i--) {
    var yearLiEl = document.createElement('option');
...
;
},{"./renderMovies.js":"js/renderMovies.js","./getMovies.js":"js/getMovies.js","./scroll.js":"js/scroll.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
